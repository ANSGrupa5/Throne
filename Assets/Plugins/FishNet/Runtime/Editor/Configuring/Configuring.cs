...
namespace FishNet.Configuring
{
    public class Configuration
    {
        ...
        private static readonly string ConfigDirectoryPath = Path.Combine("Assets", "Plugins", "FishNet");
        ...
        {
            return Path.Combine(Directory.GetCurrentDirectory(), ConfigDirectoryPath, CONFIG_FILE_NAME);
        }
